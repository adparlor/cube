  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_start() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, expression) { if (!expression.filter) expression.filter = noop; return expression; })(pos0, result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_event_filter_expression() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              result3 = parse__();
              if (result3 !== null) {
                result4 = parse_event_alternative_member_expression();
                if (result4 !== null) {
                  result5 = parse__();
                  if (result5 !== null) {
        ...
        if (result0 === null) {
          ...
          if (result0 !== null) {
            result0 = (function(offset, op, member) { return function(o) { op(o, member.field); }; })(pos0, result0[0], result0[4]);
          }
          if (result0 === null) {
            pos = pos0;
          }
      ...
      function parse_event_primary_expression() {
        ...
        result0 = parse_event_alternative_member_expression();
        if (result0 === null) {
          pos0 = pos;
          result0 = parse_number();
          if (result0 !== null) {
      ...
      function parse_event_alternative_member_expression() {
        ...
        if (result0 !== null) {
          ...
          if (result2 !== null) {
            ...
            if (result3 !== null) {
              result4 = parse__();
              if (result4 !== null) {
                result5 = parse_event_member_expression();
                if (result5 !== null) {
                  result2 = [result2, result3, result4, result5];
                } else {
                  result2 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, head, tail) { return alternativeMember(head, tail); })(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
                  ...
                  if (result0 === null) {
                    ...
                    if (result0 === null) {
                      ...
                      if (result0 === null) {
                        ...
                        if (result0 !== null) {
                          result0 = (function(offset) { return filterNin; })(pos0);
                        }
                        if (result0 === null) {
                          pos = pos0;
                        }
                        if (result0 === null) {
                          ...
                          if (result0 !== null) {
                            result0 = (function(offset) { return filterExists; })(pos0);
                          }
                          if (result0 === null) {
                            pos = pos0;
                          }
      ...
      function computeErrorPosition() {
        ...
        function filterExists(o, k, v) {
          var f = o[k];
            switch (typeof f) {
              case "undefined": o[k] = f = {}; // continue
              case "object": f["$exists"] = true; break;
              // otherwise, observe the existing equals (literal) filter
            }
        }
